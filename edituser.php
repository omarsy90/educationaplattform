    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="GET" action="testcode.php">
                        ...
                        <div class="form-row p-t-20">
                            <label class="label label--block">type of the ueser?</label>
                            <div class="p-t-15">
                                <label class="radio-container m-r-55">teacher
                                    <input type="radio" checked="checked" name="teacher">
